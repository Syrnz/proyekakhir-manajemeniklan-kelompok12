                    ...
                    <div class="grid grid-cols-12 gap-4 md:gap-6">
                        <div class="col-span-12 space-y-6">
                            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                                ...
                                if (isset($_POST['tambahData'])) {
                                    ...
                                    if ($error === "") {
                                        if (
                                            ...
                                            $sql = "INSERT INTO lokasi_iklan 
                                                        (id_jenis, kode_lokasi, nama_lokasi, alamat, harga, status, created_at)
                                                    VALUES 
                                                        (:id_jenis, :kode_lokasi, :nama_lokasi, :alamat, :harga, 'maintenance', CURRENT_TIMESTAMP)";
                                ...
                                <!-- Form -->
                                <form action="tambah_lokasi.php" method="POST" enctype="multipart/form-data">
                                    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                                            ...
                                            <select name="id_jenis" id="id_jenis"
                                                ...
                                                <?php foreach ($jenisList as $l) : ?>
                                                    <option value="<?= $l['id_jenis'] ?>"
                                                        <?= (isset($_POST['id_jenis']) && $_POST['id_jenis'] == $l['id_jenis']) ? 'selected' : '' ?>>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value="<?= isset($_POST['kode_lokasi']) ? htmlspecialchars($_POST['kode_lokasi']) : '' ?>"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value="<?= isset($_POST['nama_lokasi']) ? htmlspecialchars($_POST['nama_lokasi']) : '' ?>"
                                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
