                            ...
                            <div class="col-span-12 space-y-6">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-4 md:gap-6">
                                    ...
                                    <div
                                        ...
                                        $jumlahIklanAktif = $dataIklan['jumlahIklan'] ?? 0; // Jika kosong/null, set ke 0
                                        ?>
                                    ...
                                    <div
                                        ...
                                        $SemuaRiwayat = $dataRiwayat['totalOrder'] ?? 0; // Jika kosong/null, set ke 0
                                        ?>
                                        <div class="mt-5 flex items-end justify-between">
                                            <div>
                                    ...
                                    <div
                                        ...
                                        $Semuaiklanselesai = $dataiklanselesai['iklanSelesai'] ?? 0; // Jika kosong/null, set ke 0
                                        ?>
                                        <div class="mt-5 flex items-end justify-between">
                                            <div>
                                    ...
                                    <div
                                        ...
                                        $Semualokasi = $datalokasi['statustersedia'] ?? 0; // Jika kosong/null, set ke 0
                                        ?>
                                        <div class="mt-5 flex items-end justify-between">
                                            <div>
