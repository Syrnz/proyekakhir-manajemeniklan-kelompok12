...
<header
    ...
    <div
        ...
        <div
            ...
            <!-- Hamburger Toggle BTN -->
            <a href="../main/dashboard.php" class="lg:hidden">
        ...
        <div
            ...
            <div
                ...
                <a
                    ...
                    <span class="text-theme-sm mr-1 block font-medium"><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'Username'; ?></span>
