                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a
                            ...
                            class="menu-item group <?= ($current_page == 'daftar_invoice.php') ? 'menu-item-active' : 'menu-item-inactive'; ?>"
                            :class="(selected === 'Invoice') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg
                        ...
                        <div
                            ...
                            <ul
                                ...
                                <li>
                                    <a
                                        href="../pembayaran/daftar_invoice.php"
                                        class="menu-dropdown-item group <?= ($current_page == 'daftar_invoice.php') ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'; ?>">
                                        Daftar Invoice
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li>
                        ...
                        <div
                            ...
                            <ul
                                ...
                                <li>
                                    <a
                                        href="../riwayat/riwayat_pembayaran.php"
                                        class="menu-dropdown-item group <?= ($current_page == 'riwayat_pembayaran.php') ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'; ?>">
                                        Lihat Data Riwayat Pembayaran
                                    </a>
                                </li>
                            </ul>
                        </div>
